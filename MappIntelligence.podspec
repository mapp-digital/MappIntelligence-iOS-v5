Pod::Spec.new do |s|
    ...
    #s.tvos.vendored_frameworks = 'MappIntelligence/UserMatching/AppoxeeSDK.xcframework'
    #s.watchos.vendored_libraries ='MappIntelligence/UserMatching/AppoxeeSDK.xcframework/watchos-arm64_arm64_32/libAppoxeeSDK.a', 'MappIntelligence/UserMatching/AppoxeeSDK.xcframework/watchos-arm64_x86_64-simulator/libAppoxeeSDKWatchSim.a'
end
