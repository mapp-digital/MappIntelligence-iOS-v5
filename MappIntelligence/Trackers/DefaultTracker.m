...
- (void) checkIfAppUpdated {
    ...
    if (properties.isAppUpdated) {
        ...
        ActionEvent *updateEvent = [[ActionEvent alloc] initWithName:@"webtrekk_ignore" pageName:@"0" actionProperties:actionProperties sessionProperties:sessionProperties userProperties:nil ecommerceProperties:nil advertisementProperties:nil];
