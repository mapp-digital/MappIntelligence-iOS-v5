...
- (NSError *_Nullable)trackPageWithViewController:(UIViewController *_Nonnull)controller event:(MIPageViewEvent*_Nonnull) event {
    return [_mappIntelligence trackPageWithViewController:controller event:event];
}
